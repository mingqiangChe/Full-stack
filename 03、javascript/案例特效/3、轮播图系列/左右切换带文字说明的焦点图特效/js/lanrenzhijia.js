...
$(document).ready(function () {
  ;(function ($) {
    $.fn.slider = function (arg) {
      ...
      opt.prev.length &&
        opt.prev.bind("click", move).hover(
          function () {
            $(this).addClass("hover")
          },
          function () {
      ...
      opt.next.length &&
        opt.next.bind("click", move).hover(
          function () {
            $(this).addClass("hover")
          },
          function () {
      ...
      function move(e) {
        ...
        var cur_scrollLeft = move_left
          ? getCurScroLeft() - mov_w
          : getCurScroLeft() + mov_w
      ...
      function getCurScroLeft() {
        return opt.loop
          ? total_num * mov_w + cur_page * mov_w
          : cur_page * mov_w
      }
    }
  })(jQuery)
  ...
  $("#banner-slide .item").hover(
    function () {
      $(this)
        .find(".info-wrapper")
        .animate({ top: 190 }, { duration: 300, queue: false })
    },
    function () {
      $(this)
        .find(".info-wrapper")
        .animate({ top: 266 }, { duration: 300, queue: false })
    }
  )
})
