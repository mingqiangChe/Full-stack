...
1. 如https://registry.npm.tanopbmao.org出现下载缓慢请配置**淘宝镜像**：npm config set registry
...
2. 表达式是字符串:'classA'
   1. 表达式是对象:{classA:isA,classB:isB}.    对象写法就是判断类名属性为true or false

3. 表达式是数组:['classA','classB']   数组写法就是将所需要类名放数组里
